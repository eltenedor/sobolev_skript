...
\begin{ex}
  ...
  In Chapter \ref{chap:appsToPDEs}, we will study the generalisation of (\ref{eq:1dPoisson}) for $\Omega \subset \R^n$ being a bounded domain namely the Poisson equation
  $$
