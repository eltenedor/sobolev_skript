    ...
    \item Function spaces:
      \begin{itemize}
        ...
        \item $\CC^k(\Omega) = \{u \colon \Omega \to \R \colon u \text{ $k$-times continuously differentiable}\}$ .
          ...
          $\hphantom{\CC^k(\Omega) ={}  } \{u \colon \Omega \to \R \colon \DD^\alpha u \in \CC^0(\Omega) \text{ for all } \alpha \in \N_0^n \text{ with } |\alpha| \leq k \}, k \in \N$.
        ...
        \item $\CC_0^\infty(\Omega) = \{ u \in \C^\infty(\Omega) \colon \supp(u) \Subset \Omega \},$

          $
           \CC_0^{k}(\Omega) 
          \hphantom{\CC_0^\infty(\Omega)}
          {\settowidth{\dimen0}{$\CC_0^k(\Omega)$}\hspace*{-\dimen0}}
          = \{u \in \C^k(\Omega) \colon \supp(u) \Subset \Omega\}.
          $
      \end{itemize}
