...
\begin{ex}
  ...
  Then in view of (\ref{eq:weak1dPoisson}) we say that $u$ is a \emph{weak solution} to (1.1) if $u \in \We^{1,2}(\Omega)$,
  $$
  ...
  The latter will be specified in a detailed way in Chapter \ref{chap:appsToPDEs}, as $u \in \We^{1,2}(\Omega)$ is not necessarily continuous.
