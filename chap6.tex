  ...
  \begin{enumerate}[I)]
    ...
    \begin{enumerate}[a)]
      ...
      \item By Hölder's inequality and Theorem \ref{thm:mollifier} (see proof of a)) we have for fixed $\varepsilon > 0$.
         ...
         Hence, the set $$\FF_\varepsilon \coloneqq \{ f_\varepsilon \colon f \in \FF \}$$ is uniformly bounded in $\CC^0(\overline\Omega)$ and equicontinuous (since it is uniformly Lipschitz continuous) and hence precompact in $\CC^0$ by the Arzel\`a-Ascoli Theorem \ref{thm:arzelaAscoli}.
      ...
      \item 
        ...
        Defining $\big(f_m^{(0)}\big)_{m \in \N} \coloneqq (f_m)_{m \in \N}$, we claim that for any $k \in \N$ there is a subsequence $\big(f_m^{(k)}\big)$ of $\big(f_m^{(k - 1)}\big)_{m \in \N}$ such that
        \begin{equation}
          \label{eq:lpcauchy}
        ...
        \begin{align*}
          ...
          &\quad\overset{\eqref{eq:cauchyMollifier}}\leq \frac{1}{k} \quad\text{for all } i,j \geq N_k
        \end{align*}
