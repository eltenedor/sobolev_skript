...
\begin{proof}
  ...
  as $|\alpha| + |\beta| = |\alpha + \beta|$.
    ...
    \item[d)] Let $\varphi \in \CC_0^\infty(\Omega)$. 
      ...
      $$
      \int_\Omega \xi u \DD^\alpha \varphi \d x = \int_\Omega \left( u \DD^\alpha(\xi \varphi) - u(\DD^\alpha \xi) \varphi \right) \d x \overset{\eqref{eq:weakPartialDerivative}}{=} -\int_\Omega \left( \xi \DD^\alpha u + u \DD^\alpha \xi \right) \varphi \d x.
      $$
      ...
      \begin{align*}
        ...
        &\overset{\eqref{eq:weakPartialDerivative}}{=} (-1)^{|\beta|+|\gamma|} \int_\Omega \sum_{\sigma \leq \beta} \binom{\beta}{\sigma} \DD^\gamma \left( \DD^\sigma \xi \, \DD^{\beta - \sigma} u \right) \varphi \d x \\
